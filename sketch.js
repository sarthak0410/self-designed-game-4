...
var enemyGroup, rotton,rottonImg;

function preload(){
fruit1=loadImage("apple.png")
fruit2=loadImage("banana.png.png")
rottonImg=loadImage("rotton.png")
...
function Enemy(){
  if(World.frameCount%200===0){
    rotton=createSprite(400,200,20,20);
    rotton.addImage("rotton",rottonImg);
    rotton.y=Math.round(random(100,300));
    //monster.velocityX=-(8+(score/10));
    rotton.setLifetime=50;
    
    enemyGroup.add(rotton);
  }
}
